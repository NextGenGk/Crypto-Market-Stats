                ...
                <div className='content'>
                    ...
                    <div className='info'>
                        ...
                        <div className='coin-price'>
                            {coin.market_data?.current_price ? <h1>INR {coin.market_data.current_price.inr.toLocaleString()}</h1> : null}
                        </div>
                    </div>
                </div>
                ...
                <div className='content'>
                    <div className='stats'>
                        <div className='left'>
                            <div className='row'>
                                <h4>24 Hour Low</h4>
                                {coin.market_data?.low_24h ? <p>INR {coin.market_data.low_24h.inr.toLocaleString()}</p> : null}
                            </div>
                            <div className='row'>
                                <h4>24 Hour High</h4>
                                {coin.market_data?.high_24h ? <p>INR {coin.market_data.high_24h.inr.toLocaleString()}</p> : null}                            </div>

                        </div>
                        <div className='right'>
                            <div className='row'>
                                <h4>Market Cap</h4>
                                {coin.market_data?.market_cap ? <p>INR {coin.market_data.market_cap.inr.toLocaleString()}</p> : null}
                            </div>
                            <div className='row'>
